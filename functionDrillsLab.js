...
function nameCheck(name) {
 ...
 let nameGreeting = nameCheck("Mae");
...
//CODE HERE
const bestMovie = title => `${title} in the best movie ever!`;
console.log(bestMovie("Charlie's Angels"));
...
//CODE HERE
function asUppercase(phrase){
    phrase = String(phrase)
    console.log(phrase.toUpperCase())
}
asUppercase(sampleString);
////////////////// PROBLEM 18 ////////////////////
/*
...
//CODE HERE
const buyFrogsWithGold = gold => Math.floor(gold / 3);
    let totalFrogs = buyFrogsWithGold(78);
...
//CODE HERE
const buyFrogsWithGold2 = gold => Math.floor(gold / 3);
    let totalFrogs = buyFrogsWithGold(4);
